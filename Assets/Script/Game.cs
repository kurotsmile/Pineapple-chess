...
public class Game : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        this.carrot.shop.onCarrotPaySuccess += this.shop.OnPaySuccess;
        ...
        {
            this.change_skin_player(this.shop.list_Item_Obj[index_skin].sp_items[0], this.shop.list_Item_Obj[index_skin].sp_items[1]);
        });
    }
    ...
    public void select_skin_player(int index_skin)
    {
        ...
        Sprite spA = this.shop.list_Item_Obj[index_skin].sp_items[0];
        Sprite spB = this.shop.list_Item_Obj[index_skin].sp_items[0];
        this.change_skin_player(spA,spB);
        this.play_sound();
    }


    public void change_skin_player(Sprite sp1,Sprite sp2)
    {
        this.sp_tomato_red = sp1;
        this.sp_tomato_orange = sp2;
